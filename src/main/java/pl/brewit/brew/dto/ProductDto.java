...
public class ProductDto {
    ...
    public ProductDto(@NotBlank @Size(max = 75) String name, boolean isTemplate, UUID countriesDictionaryId,
                      UUID productTypesDictionaryId, Set<ProductParameterDto> productParameters) {
        this.name = name;
