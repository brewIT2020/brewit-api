...
public class ProductTypesDictionary extends BaseEntity {
  ...
  public ProductTypesDictionary(
      String name,
      Set<ProductParametersDictionary> productParametersDictionaries,
      Set<BrewingToolsDictionary> brewingToolsDictionaries) {
    this.name = name;
  ...
  public void setProductParametersDictionaries(
      Set<ProductParametersDictionary> productParametersDictionaries) {
    this.productParametersDictionaries = productParametersDictionaries;
  }
